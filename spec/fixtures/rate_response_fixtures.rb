...
module RateResponseFixtures
  ...
  def successful_get_rate_response
    %({"data":#{successful_get_rate_response_message.to_json}})
  end
  ...
  def successful_rates_list_response
    %({"data":#{successful_rates_list_response_message.to_json}})
  end
  ...
  def successful_create_rate_response
    %({"data":#{successful_create_rate_response_message.to_json}})
  end

  def successful_update_rate_response_message
    {
      'apply_from' => '2021-06-08T00:00:00.000000Z',
      'created_at' => '2021-06-08T00:00:00.000000Z',
      'currency' => 'BYN',
  ...
  def successful_update_rate_response
